...
//  assertEquals("Checking if recipe5 is still in list", true, RecipeAPI.getRecipeMap().get(4).getFavorite());
  ...
  assertEquals("Checking if restaurant1 is still in list", true, RestAPI.getRestaurantMap().get(1).getToExplore());
  assertEquals("Checking if restaurant2 is still in list", true, RestAPI.getRestaurantMap().get(2).getToExplore());
  ...
  assertEquals("Checking if restaurant1 is still in list", true, RestAPI.getRestaurantMap().get(1).getDoNotShow());
  assertEquals("Checking if restaurant2 is still in list", true, RestAPI.getRestaurantMap().get(2).getDoNotShow());
