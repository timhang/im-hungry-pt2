...
//	}
	...
	*/
	...
	public void testResultsPageList() {
		...
		try {
			assertEquals("Mismatch on results page list - null tests", 3, recipeAPI.resultsPageList("burger", "3").size());
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (Exception e) {
		...
		try {
			assertEquals("Mismatch on results page list - null tests", 7, recipeAPI.resultsPageList("burger", "7").size());
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (Exception e) {
		...
		try {
			assertEquals("Mismatch on results page list - null tests", 7, recipeAPI.resultsPageList("pizza", "7").size());
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (Exception e) {
		...
		try {
			assertEquals("Mismatch on results page list - null tests", 5, recipeAPI.resultsPageList("burger", "5").size());
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (Exception e) {
		...
		try {
			assertEquals("Mismatch on results page list - null tests", 5, recipeAPI.resultsPageList("burger", null).size());
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (Exception e) {
