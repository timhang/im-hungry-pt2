	...
	%>
		...
		<script>
			...
			deleteButton.onclick = function () {
				...
				xhttp.open("GET", "DeleteItem?restIds=" + linkRest + "&recipeIds=" + linkRecipe + "&list=exp", true);
			...
			moveButton.onclick = function() {
				if(moveDropdown.selectedIndex != "0" && moveDropdown.selectedIndex != "2"){
					...
					console.log(linkRest);
					console.log(linkRecipe);
					xhttp.open("GET", "MoveItem?restIds=" + linkRest + "&recipeIds=" + linkRecipe + "&list=exp&to="+moveDropdown.selectedIndex, true);
					xhttp.onreadystatechange = function() {
						//window.location.reload(true);
